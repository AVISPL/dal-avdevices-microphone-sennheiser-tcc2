...
public enum SennheiserPropertiesList {
	...
	INPUT_LEVEL_GAIN_STATUS(SennheiserConstant.INPUT_LEVEL_GAIN_STATUS, SennheiserCommands.INPUT_LEVEL_GAIN_STATUS_CONTROLLING, true),
	INPUT_LEVEL_GAIN_PRESET(SennheiserConstant.INPUT_LEVEL_GAIN_PRESET, SennheiserCommands.INPUT_LEVEL_GAIN_CONTROLLING, true),
